...
-- ----------------------------
-- Table structure for z_auth_access
-- ----------------------------
DROP TABLE IF EXISTS `z_auth_access`;
CREATE TABLE `z_auth_access` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `z_nav` (
  ...
  `is_enable` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '是否为主导航;1:是;0:不是',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '导航位置名称',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='前台导航类别';
...
-- ----------------------------
-- Table structure for z_nav_menu
-- ----------------------------
DROP TABLE IF EXISTS `z_nav_menu`;
CREATE TABLE `z_nav_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nav_id` int(11) NOT NULL COMMENT '导航 id',
  `parent_id` int(11) NOT NULL COMMENT '父 id',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态;1:显示;0:隐藏',
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '菜单名称',
  `target` varchar(10) NOT NULL DEFAULT '' COMMENT '打开方式',
  `href` varchar(200) NOT NULL DEFAULT '' COMMENT '链接',
  `icon` varchar(20) NOT NULL DEFAULT '' COMMENT '图标',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='前台导航菜单列表';

-- ----------------------------
-- Records of z_nav_menu
-- ----------------------------
...
CREATE TABLE `z_post` (
  ...
  `post_hits` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for z_slide_item
-- ----------------------------
DROP TABLE IF EXISTS `z_slide_item`;
CREATE TABLE `z_slide_item` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
